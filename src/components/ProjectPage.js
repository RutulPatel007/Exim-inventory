...
export const ProjectPage = () => {
  ...
  const dyeData = [
    { name: 'Reactive Red M5B', code: 'Reactive Red - 2', light: '4-5', washing: '4-5', perspiration: '3-4', hypochlorite: '1', dischargeability: 'P', color: '#ca0051' },
    { name: 'Reactive Red M8B', code: 'Reactive Red - 11', light: '4-5', washing: '4-5', perspiration: '2', hypochlorite: '4', dischargeability: 'P', color: '#a60042' },
    { name: 'Reactive Magenta MB', code: 'Reactive Violet - 13', light: '4-5', washing: '5', perspiration: '4-5', hypochlorite: '1', dischargeability: 'F', color: '#840084' },
    { name: 'Reactive Orange M2R', code: 'Reactive Orange - 4', light: '5', washing: '5', perspiration: '4', hypochlorite: '4', dischargeability: 'P', color: '#ff6600' },
    { name: 'Reactive Orange M2RJ', code: '', light: '3-4', washing: '4', perspiration: '4', hypochlorite: '4-5', dischargeability: 'P', color: '#d92c00' },
    { name: 'Reactive Gol. Yellow MR', code: 'Reactive Yellow - 44', light: '5', washing: '4-5', perspiration: '4', hypochlorite: '1', dischargeability: 'P', color: '#ffa41a' },
    { name: 'Reactive Yellow MR EX H/C', code: 'Reactive Yellow - 44', light: '5', washing: '4-5', perspiration: '4', hypochlorite: '1', dischargeability: 'P', color: '#ff9933' },
    { name: 'Reactive Yellow M3R', code: 'Reactive Yellow - 36', light: '6', washing: '5', perspiration: '4', hypochlorite: '2', dischargeability: 'G', color: '#f47a00' },
    { name: 'Reactive Yellow M4R', code: 'Reactive Orange - 14', light: '5', washing: '4-5', perspiration: '4', hypochlorite: '1', dischargeability: 'P', color: '#d26900' },
    { name: 'Reactive Yellow M8G', code: 'Reactive Yellow - 86', light: '6', washing: '4-5', perspiration: '4-5', hypochlorite: '1', dischargeability: 'G', color: '#fcf018' },
    { name: 'Reactive Yellow M4G', code: 'Reactive Yellow - 22', light: '6', washing: '4', perspiration: '5', hypochlorite: '1', dischargeability: 'G', color: '#f2f200' },
    { name: 'Reactive Yellow MGR', code: 'Reactive Yellow - 7', light: '6', washing: '5', perspiration: '4-5', hypochlorite: '4-5', dischargeability: 'P', color: '#ff9933' },
    ...
    { name: 'Reactive Blue MR', code: 'Reactive Blue - 4', light: '6', washing: '5', perspiration: '5', hypochlorite: '2', dischargeability: 'P', color: '#004f9d' },
    { name: 'Reactive Blue M2R', code: 'Reactive Blue - 81', light: '6', washing: '5', perspiration: '4-5', hypochlorite: '1', dischargeability: 'P', color: '#002e5b' },
    { name: 'Reactive Blue M2R H/C', code: 'Reactive Blue - 81', light: '6', washing: '5', perspiration: '4-5', hypochlorite: '1', dischargeability: 'P', color: '#002f5e' },
    { name: 'Reactive Navy Blue M3R', code: 'Reactive Blue - 9', light: '5', washing: '4-5', perspiration: '3', hypochlorite: '3', dischargeability: 'P', color: '#000051' },
    { name: 'Reactive Blue M4GD H/C', code: 'Reactive Blue - 168', light: '6', washing: '5', perspiration: '3-4', hypochlorite: '2', dischargeability: 'P', color: '#000040' },
    { name: 'Reactive Tur. Blue MGN', code: 'Reactive Blue - 140', light: '6', washing: '4', perspiration: '4', hypochlorite: '2-3', dischargeability: 'P', color: '#00bbea' },
    { name: 'Reactive Tur. Blue Ha5G', code: 'Reactive Blue - 71', light: '6', washing: '3-4', perspiration: '4-5', hypochlorite: '3-4', dischargeability: 'P', color: '#009ed2' },
  ];



  const dyeData2 = [
    { name: 'Reactive Yellow HE6G', code: 'Reactive Yellow - 135', light: '4-5', washing: '4', perspiration: '4', hypochlorite: '1', dischargeability: 'G', color: '#f9f900' },
    { name: 'Reactive Yellow HE4R', code: 'Reactive Yellow - 81', light: '5-6', washing: '5', perspiration: '4-5', hypochlorite: '1-2', dischargeability: 'G', color: '#ffcf0f' },
    { name: 'Reactive Yellow HE4R', code: 'Reactive Yellow - 84', light: '5-6', washing: '5', perspiration: '4-5', hypochlorite: '2-3', dischargeability: 'P', color: '#ffa620' },
    { name: 'Reactive G. Yellow HE4R', code: 'Reactive Yellow - 81-A', light: '5', washing: '5', perspiration: '4-5', hypochlorite: '3-4', dischargeability: 'P', color: '#fb7d00' },
    { name: 'Reactive Orange HER', code: 'Reactive Orange - 84', light: '3-4', washing: '4', perspiration: '4', hypochlorite: '4-5', dischargeability: 'P', color: '#d13001' },
    { name: 'Reactive Orange HE2R', code: 'Reactive Orange - 84-A', light: '3-4', washing: '4', perspiration: '4', hypochlorite: '4-5', dischargeability: 'P', color: '#e82f00' },
    { name: 'Reactive Red HE3B', code: 'Reactive Red - 120', light: '5', washing: '5', perspiration: '4-5', hypochlorite: '1', dischargeability: 'P', color: '#e1005a' },
    { name: 'Reactive Red HE5B', code: '', light: '4-5', washing: '5', perspiration: '5', hypochlorite: '3', dischargeability: 'P', color: '#c40062' },
    { name: 'Reactive Red HE7B', code: 'Reactive Red - 141', light: '4-5', washing: '5', perspiration: '5', hypochlorite: '3', dischargeability: 'P', color: '#a40052' },
    { name: 'Reactive Red HE8B', code: 'Reactive Red - 152', light: '4-5', washing: '5', perspiration: '5', hypochlorite: '3-4', dischargeability: 'P', color: '#741d57' },
    { name: 'Reactive Green HE 4B', code: 'Reactive Green - 19', light: '4', washing: '4-5', perspiration: '4-5', hypochlorite: '1', dischargeability: 'F', color: '#006600' },
    { name: 'Reactive Green HE 4BD', code: 'Reactive Green - 19A', light: '4', washing: '5', perspiration: '4-5', hypochlorite: '1', dischargeability: 'F', color: '#004f00' },
    { name: 'Reactive Black HEBL', code: '', light: '4', washing: '5', perspiration: '4', hypochlorite: '3', dischargeability: 'P', color: '#00004a' },
    { name: 'Reactive Navy Blue HER', code: 'Reactive Blue - 171', light: '4', washing: '5', perspiration: '4', hypochlorite: '1-2', dischargeability: 'F', color: '#00006f' },
    { name: 'Reactive Navy Blue HE2R', code: 'Reactive Blue - 172', light: '4', washing: '4-5', perspiration: '4', hypochlorite: '2', dischargeability: 'F', color: '#000066' },
    { name: 'Reactive Blue HERD', code: 'Reactive Blue - 160', light: '6', washing: '5', perspiration: '4', hypochlorite: '3', dischargeability: 'F', color: '#0088aa' },
    { name: 'Reactive Navy Blue HEGN', code: 'Reactive Blue - 198', light: '4-5', washing: '4-5', perspiration: '3-4', hypochlorite: '3', dischargeability: 'F', color: '#06bcc6' },
  ];
  ...
  const dyeData3 = [
    ...
    { name: 'Reactive Yellow H4G', code: 'Reactive Yellow - 18', light: '6', washing: '5', perspiration: '5', hypochlorite: '1', dischargeability: 'G', color: '#ffff7d' },
    { name: 'Reactive Gol. Yellow HR', code: 'Reactive Yellow - 12', light: '6', washing: '5', perspiration: '5', hypochlorite: '3', dischargeability: 'F', color: '#e17100' },
    { name: 'Reactive Orange H2R', code: 'Reactive Orange - 13', light: '4', washing: '5', perspiration: '4', hypochlorite: '4', dischargeability: 'P', color: '#bf3000' },
    { name: 'Reactive Red H8B', code: 'Reactive Red - 31', light: '4', washing: '4', perspiration: '4', hypochlorite: '3', dischargeability: 'P', color: '#97004b' },
    { name: 'Reactive Red 6BX', code: 'Reactive Red - 76', light: '4', washing: '4', perspiration: '5', hypochlorite: '2', dischargeability: 'P', color: '#cc0066' },
    { name: 'Reactive Red Brown H4R', code: 'Reactive Brown - 9', light: '4', washing: '5', perspiration: '4', hypochlorite: '5', dischargeability: 'P', color: '#660033' },
    { name: 'Reactive Magenta HB', code: 'Reactive Violet - 13', light: '4', washing: '4', perspiration: '4', hypochlorite: '1', dischargeability: 'F', color: '#a2287a' },
    { name: 'Reactive Purple H3R', code: 'Reactive Violate - 1', light: '6', washing: '4', perspiration: '5', hypochlorite: '4', dischargeability: 'P', color: '#990099' },
    { name: 'Reactive Black HN', code: 'Reactive Black - 8', light: '5', washing: '4', perspiration: '5', hypochlorite: '4', dischargeability: 'P', color: '#42422d' },
    { name: 'Reactive Blue H5R', code: 'Reactive Blue - 13', light: '5', washing: '5', perspiration: '5', hypochlorite: '1', dischargeability: 'P', color: '#001e75' },
    { name: 'Reactive Blue H2R', code: '', light: '4', washing: '4', perspiration: '4', hypochlorite: '2', dischargeability: 'P', color: '#004e82' },
    { name: 'Reactive Blue H3RP', code: 'Reactive Blue - 49', light: '4', washing: '5', perspiration: '4', hypochlorite: '2', dischargeability: 'P', color: '#b7b9d2' },
    { name: 'Reactive Tur. Blue H5G', code: 'Reactive Blue - 25', light: '5-6', washing: '4-5', perspiration: '3', hypochlorite: '3-4', dischargeability: 'P', color: '#00c0f0' },
    { name: 'Reactive Navy Blue RX', code: 'Reactive Blue - 59', light: '3', washing: '3-4', perspiration: '4-5', hypochlorite: '1', dischargeability: 'P', color: '#000066' },
  ];
  ...
  const dyeData4 = [
    { name: 'Reactive Red ME4BL', code: 'Reactive Red - 195', light: '6', washing: '4-5', perspiration: '4-5', hypochlorite: '3', dischargeability: 'P', color: '#ff0066' },
    { name: 'Reactive Red ME6BL', code: 'Reactive Red - 196/250', light: '5', washing: '4-5', perspiration: '4', hypochlorite: '3-4', dischargeability: 'F', color: '#bb005e' },
    { name: 'Reactive Red ME3BL', code: 'Reactive Red - 180', light: '5-6', washing: '5', perspiration: '5', hypochlorite: '1', dischargeability: 'P', color: '#ea0075' },
    { name: 'Reactive Orange ME2RL', code: 'Reactive Orange - 122', light: '5', washing: '5', perspiration: '4', hypochlorite: '2', dischargeability: 'P', color: '#cc0000' },
    { name: 'Reactive G. Yellow MERL', code: 'Reactive Yellow - 145', light: '5', washing: '5', perspiration: '4', hypochlorite: '4', dischargeability: 'F', color: '#eaaf00' },
    { name: 'Reactive Yellow ME3RL', code: '', light: '6', washing: '4-5', perspiration: '4-5', hypochlorite: '1', dischargeability: 'F', color: '#fdc61e' },
    { name: 'Reactive Yellow ME4GL', code: 'Reactive Yellow-160/186', light: '6', washing: '4-5', perspiration: '4-5', hypochlorite: '1', dischargeability: 'F', color: '#f0f000' },
    { name: 'Reactive Green ME4GL', code: '', light: '4-5', washing: '4-5', perspiration: '4', hypochlorite: '1', dischargeability: 'F', color: '#004200' },
    { name: 'Reactive Blue ME2RL', code: 'Reactive Blue - 158', light: '4', washing: '5', perspiration: '4', hypochlorite: '1', dischargeability: 'F', color: '#000077' },
    ...
    { name: 'Reactive Jet Black HFGR', code: '', light: '5-6', washing: '5', perspiration: '5', hypochlorite: '2', dischargeability: 'F', color: '#292929' },
    { name: 'Reactive Black HFGR', code: '', light: '4', washing: '5', perspiration: '4', hypochlorite: '3', dischargeability: 'G', color: '#000000' },
    { name: 'Reactive Copper Blue BF', code: 'Reactive Blue - 221', light: '6-7', washing: '4', perspiration: '4', hypochlorite: '2', dischargeability: 'G', color: '#002164' },
    { name: 'Reactive Blue BF', code: 'Reactive Blue - 222', light: '4-5', washing: '4', perspiration: '4', hypochlorite: '2', dischargeability: 'G', color: '#001237' },
  ];
...
<section className="project_page1">
      <Container>
